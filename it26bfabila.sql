...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2025 at 03:30 PM
...
(232, 'Sopia', 'Solana', 'lorraine@gmail.com', 0),
(302, 'Diana', 'Gabaran', 'dianarose@gmail.com', 1),
(330, 'Mariel', 'Doydora', 'maryel@gmail.com', 2);
...
(1001, 5001, '0000-00-00', 302),
(1002, 5002, '0000-00-00', 232),
(1003, 5003, '0000-00-00', 330);
...
ALTER TABLE `sales`
  ...
  ADD CONSTRAINT `fk_sales_customer_id` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
